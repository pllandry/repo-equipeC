        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="login.html" class="btn btn-default btn-xs nav-login">Se connecter</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <a href="inscription.html" class="btn btn-default btn-xl">S'inscrire</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                ...
                <a href="inscription.html" class="btn btn-default btn-xl wow tada">Inscris toi maintenant</a>
            </div>
        </div>
    </aside>
